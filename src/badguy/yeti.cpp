...
namespace {
  ...
  const float JUMP_UP_VY = -640; /**< vertical speed while jumping on the dais */
  ...
  const float RIGHT_STAND_X = 640-48-13; /**< x-coordinate of right dais' end position */
  const float LEFT_JUMP_X = LEFT_STAND_X+180; /**< x-coordinate of from where to jump on the left dais */
  const float RIGHT_JUMP_X = RIGHT_STAND_X-180; /**< x-coordinate of from where to jump on the right dais */
