...
{
  // Modern computers can handle alpha blending just fine and have since the late 90's.
  // We simply convert the surface to the display format, preserving alpha if it exists.
  if(src->format->Amask)
  {
